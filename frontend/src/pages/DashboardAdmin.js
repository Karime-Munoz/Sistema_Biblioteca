    ...
    fetch("http://127.0.0.1:8000/usuarios", {
      ...
      .then(data => {
        if (data.detail) {
          ...
          setUsuarios([...usuarios, nuevoUsuario]); // Agregar a la lista
  ...
  return (
    <div className="dashboard-admin">
      ...
      <div className="admin-buttons">
        <button className="btn-add" onClick={() => setModalVisible(true)}>Agregar Usuario</button>
      ...
      {modalVisible && (
        <div className="modal">
          <div className="modal-content">
            ...
            <input type="text" name="matricula" placeholder="Matrícula" onChange={handleInputChange} required />
            <select name="rol" onChange={handleInputChange}>
              <option value="Alumno">Alumno</option>
              <option value="Profesor">Profesor</option>
              <option value="Administrador">Administrador</option>
            </select>
            <input type="password" name="contrasena" placeholder="Contraseña" onChange={handleInputChange} required />
            ...
            {libros.map(libro => (
              <li key={libro.id} className="list-item">
                ...
                <div className="list-actions">
                  <button className={`btn-status ${libro.estado === "disponible" ? "disponible" : "prestado"}`}>
          ...
          <ul>
            {laptops.map(laptop => (
              <li key={laptop.id} className="list-item">
                ...
                <div className="list-actions">
                  <button className={`btn-status ${laptop.estado === "disponible" ? "disponible" : "prestado"}`}>
